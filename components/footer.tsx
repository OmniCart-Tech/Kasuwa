      ...
      <div className="bg-[#313133]">
        <div className="max-w-[1280px] px-6 mx-auto flex flex-col gap-4 md:flex-row justify-between md:h-[260px] py-8 pt-14">
          ...
          <div className="flex flex-col gap-2 sm:m-0">
            <span className="text-xl text-white font-semibold">NEW TO KASUWA</span>
            <p className="text-white">Suscribe to our newsletter and get notified about offers</p>
            <div className="flex gap-1 max-w-[400px]">
              <input
                className="text-black rounded-md bg-white px-3 py-2 w-full"
          ...
          <div className="flex gap-2 items-start justify-start md:justify-center">
            ...
            <div className="flex flex-col gap-2">
              <p className="text-xl text-white font-semibold">DOWNLOAD KASUWA MOBILE APP FOR FREE!</p>
              <p className="text-white">Get Access to our exclusive offers</p>
              <div className="flex sm:flex-row flex-col gap-2">
                <button className="w-[200px] border-white border h-[55px] py-2 bg-transparent flex items-center gap-2 px-3">
                  <Image src={ioslogo} width={40} height={40} alt="ios" />
                  <p className="flex flex-col leading-[13px] text-white">
                    <span className="text-[14px] font-light text-left">Download on the</span>
                    <span className="text-lg text-left font-semibold">App Store</span>
                  </p>
                </button>
                <button className="w-[200px] border-white border h-[55px] py-2 bg-transparent flex items-center gap-2 px-3">
                  <Image src={googleplay} width={40} height={40} alt="play" />
                  <p className="flex flex-col leading-[13px] text-white">
                    <span className="text-[14px] font-light text-left">Get it on</span>
                    <span className="text-lg text-left font-semibold">Play Store</span>
                  </p>
                </button>
              </div>
            </div>
